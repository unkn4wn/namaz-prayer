...
public class PrayTimes implements Serializable {
    ...
    private void calculate() {
        ...
        // simple guess
        times = new double[]{5, 5, 6, 12, 12, 13, 13, 18, 18, 18, 0,2};
        ...
        //TODO midnight methods according to madhaib
        // add midnight time
        if (midnight == Midnight.Standard) {
            times[Times.Midnight.ordinal()] =
                    times[Times.Maghrib.ordinal()] + Utils.timeDiff(times[Times.Maghrib.ordinal()], times[Times.Fajr.ordinal()]) / 2.0;
        } else if (midnight == Midnight.Jafari) {
            times[Times.Midnight.ordinal()] =
                    times[Times.Maghrib.ordinal()] + Utils.timeDiff(times[Times.Maghrib.ordinal()], times[Times.Fajr.ordinal()]) / 2.0;
        }

        //TODO last THIRD methods according to madhaib
        // add lastThird time
        times[Times.LastThird.ordinal()] =
                times[Times.Sunrise.ordinal()] - Utils.timeDiff(times[Times.Maghrib.ordinal()], times[Times.Fajr.ordinal()]) / 3.0;
